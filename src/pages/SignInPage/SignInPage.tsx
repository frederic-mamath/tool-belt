...
const SignInPage = () => {
  ...
  return (
    <Stack direction="row" flex={1}>
      <Stack flex={1}>
        <img src="https://res.cloudinary.com/pokpok/image/upload/c_scale,q_15,w_567/v1669758803/conference-room-sketch_mwacth.jpg" style={{
          height: "100%",
          width: "100%"
        }} />
      </Stack>
      <Stack flex={1} p={4}>
      <Typography sx={{ textAlign: "center" }} variant="h2">Welcome</Typography>
        <form onSubmit={handleSubmit(onSubmit)} style={{
          ...
          <Stack gap={2} flex={1} justifyContent="center">
            ...
            <TextField label="Password" {...register("password")} type="password" sx={{ mb: 4 }}/>
